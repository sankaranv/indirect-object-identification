...
ABC_TEMPLATES = [
    ...
    "Afterwards [A], [B] and [C] went to the [PLACE]. [B] and [C] gave a [OBJECT] to [A]",  # noqa: E501
...
BABA_TEMPLATES = [
    ...
    "Then, [B] and [A] were working at the [PLACE]. [B] decided to give a [OBJECT] to [A]",  # noqa: E501
    "Then, [B] and [A] were thinking about going to the [PLACE]. [B] wanted to give a [OBJECT] to [A]",  # noqa: E501
    "Then, [B] and [A] had a long argument, and afterwards [B] said to [A]",
    "After [B] and [A] went to the [PLACE], [B] gave a [OBJECT] to [A]",
    "When [B] and [A] got a [OBJECT] at the [PLACE], [B] decided to give it to [A]",
    "When [B] and [A] got a [OBJECT] at the [PLACE], [B] decided to give the [OBJECT] to [A]",  # noqa: E501
...
BABA_LONG_TEMPLATES = [
    ...
    "Then in the morning, [B] and [A] had a lot of fun at the [PLACE]. [B] gave a [OBJECT] to [A]",  # noqa: E501
    "Then in the morning, [B] and [A] were working at the [PLACE]. [B] decided to give a [OBJECT] to [A]",  # noqa: E501
    "Then in the morning, [B] and [A] were thinking about going to the [PLACE]. [B] wanted to give a [OBJECT] to [A]",  # noqa: E501
    "Then in the morning, [B] and [A] had a long argument, and afterwards [B] said to [A]",  # noqa: E501
    "After taking a long break [B] and [A] went to the [PLACE], [B] gave a [OBJECT] to [A]",  # noqa: E501
    "When soon afterwards [B] and [A] got a [OBJECT] at the [PLACE], [B] decided to give it to [A]",  # noqa: E501
    "When soon afterwards [B] and [A] got a [OBJECT] at the [PLACE], [B] decided to give the [OBJECT] to [A]",  # noqa: E501
    "While spending time together [B] and [A] were working at the [PLACE], [B] gave a [OBJECT] to [A]",  # noqa: E501
    "While spending time together [B] and [A] were commuting to the [PLACE], [B] gave a [OBJECT] to [A]",  # noqa: E501
    "After the lunch in the afternoon, [B] and [A] went to the [PLACE]. [B] gave a [OBJECT] to [A]",  # noqa: E501
    "Afterwards, while spending time together [B] and [A] went to the [PLACE]. [B] gave a [OBJECT] to [A]",  # noqa: E501
    "Then in the morning afterwards, [B] and [A] had a long argument. Afterwards [B] said to [A]",  # noqa: E501
    "The local big [PLACE] [B] and [A] went to had a [OBJECT]. [B] gave it to [A]",
    "Friends separated at birth [B] and [A] found a [OBJECT] at the [PLACE]. [B] gave it to [A]",  # noqa: E501
]
...
BABA_EARLY_IOS = [
    ...
    "Then [B] and [A] were working at the [PLACE], and [B] decided to give a [OBJECT] to [A]",  # noqa: E501
    "Then [B] and [A] were thinking about going to the [PLACE], and [B] wanted to give a [OBJECT] to [A]",  # noqa: E501
    "Then [B] and [A] had a long argument, and after that [B] said to [A]",
...
def gen_flipped_prompts(prompts, names, flip=("S2", "IO")):
    ...
    Args:
        ...
        flip (tuple, optional): First element is the string to be replaced, second
            is what to replace with. Defaults to ("S2", "IO").
...
def get_end_idxs(prompts, tokenizer, name_tok_len=1, prepend_bos=False, toks=None):
    # toks = torch.Tensor(tokenizer([prompt["text"] for prompt in prompts], padding=True).input_ids).type(torch.int)  # noqa: E501
...
class IOIDataset:
    def __init__(
        ...
        ioi_prompts_for_word_idxs:
            if you want to use a different set of prompts to get the word indices,
        ...
        if not (
            ...
            warnings.warn(
                "Probably word_idx will be calculated incorrectly due to this"  # noqa: E501
                " formatting"
            )
        ...
        self.prompt_type = prompt_type
        self.filtered_names = [n for n in NAMES if len(self.tokenizer(f' {n}', add_special_tokens=False)['input_ids']) == 1]  # noqa: E501
        if prompts is None:
            self.ioi_prompts = gen_prompt_uniform(  # a list of dict of the form {"text": "Alice and Bob bla bla. Bob gave bla to Alice", "IO": "Alice", "S": "Bob"}  # noqa: E501
                self.templates,
                self.filtered_names,
                nouns_dict={"[PLACE]": PLACES, "[OBJECT]": OBJECTS},
                N=N,
        ...
        if len(small_groups) > 0:
            warnings.warn(
                f"Some groups have less than 5 prompts, they have lengths {small_groups}"  # noqa: E501
            )
    ...
    def gen_flipped_prompts(self, flip):
        ...
        if flip == "prefix":
            ...
            if flip in [("IO", "S1"), ("S", "IO")]:
                ...
                flipped_prompts = gen_flipped_prompts(
                    self.ioi_prompts, self.filtered_names, flip
                )
